...
class AcceptProposalUseCase constructor ( private val userRepository: UserRepository) {
    operator fun invoke(
        connectRequest: ConnectRequest,
    ): Flow<NetworkResult<ApiResponse>> {
        return userRepository.acceptProposalRequest(connectRequest = connectRequest)
    }
}